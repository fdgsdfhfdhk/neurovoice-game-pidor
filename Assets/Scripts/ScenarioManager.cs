...
public class ScenarioManager : MonoBehaviour
{
    ...
    [SerializeField] private CharacterBehaviour alex;
    ...
    void PlayScenario()
    {
        ...
        {
            subtitles.text = "";
            requestor.text = "В ожидании истории";
            Invoke("LoadStory", 2f);
        }
    }
    ...
    {
        using (UnityWebRequest www = UnityWebRequestMultimedia.GetAudioClip(clipUrl, AudioType.OGGVORBIS))
        {
    ...
    void CheckForSounds()
    {
        ...
        scenarioProgress = 0;
        requestor.text = "Сценарий от: " + story.requestor_id;
        PlayScenario();
    }
}
